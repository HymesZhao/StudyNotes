...
- [9、java常用类](#9java常用类)
  ...
  - [9.2、StringBuffer、StringBuilder](#92stringbufferstringbuilder)
    ...
    - [9.2.2、StringBuffer与StringBuilder的内存解析](#922stringbuffer与stringbuilder的内存解析)
...
- [11、java集合](#11java集合)
  ...
  - [11.3、Iterator接口与foreach循环](#113iterator接口与foreach循环)
...
- [15、java反射机制](#15java反射机制)
  - [15.1、反射的概述](#151反射的概述)
    ...
    - [15.1.3、反射机制能提供的功能](#1513反射机制能提供的功能)
...
- [16、Java8新特性](#16java8新特性)
  ...
  - [16.7、Optional类的使用](#167optional类的使用)
    - [16.7.1、理解](#1671理解)
...
- 内存结构：
  ...
  ![image-20210627151542174](https://github.com/HymesZhao/StudyNotes/blob/master/JavaSenior/JavaSeniorPic/image-20210627151542174.png)
...
![image-20210627162320717](https://github.com/HymesZhao/StudyNotes/blob/master/JavaSenior/JavaSeniorPic/image-20210627162320717.png)
...
#### 9.1.6.4、与StringBuffer、StringBuilder之间的转换
...
![image-20210627234739566](https://github.com/HymesZhao/StudyNotes/blob/master/JavaSenior/JavaSeniorPic/image-20210627234739566.png)
...
- 数据间的逻辑结构
  ...
  ![image-20210627235115762](https://github.com/HymesZhao/StudyNotes/blob/master/JavaSenior/JavaSeniorPic/image-20210627235115762.png)
...
![image-20210628002003622](https://github.com/HymesZhao/StudyNotes/blob/master/JavaSenior/JavaSeniorPic/image-20210628002003622.png)
...
![image-20210628002134093](https://github.com/HymesZhao/StudyNotes/blob/master/JavaSenior/JavaSeniorPic/image-20210628002134093.png)
...
![image-20210628002947653](https://github.com/HymesZhao/StudyNotes/blob/master/JavaSenior/JavaSeniorPic/image-20210628002947653.png)
...
![image-20210628004129738](https://github.com/HymesZhao/StudyNotes/blob/master/JavaSenior/JavaSeniorPic/image-20210628004129738.png)

![image-20210628004139393](https://github.com/HymesZhao/StudyNotes/blob/master/JavaSenior/JavaSeniorPic/image-20210628004139393.png)
...
![image-20210628004345844](https://github.com/HymesZhao/StudyNotes/blob/master/JavaSenior/JavaSeniorPic/image-20210628004345844.png)

### 13.2.2、流的体系结构

![image-20210628004418884](https://github.com/HymesZhao/StudyNotes/blob/master/JavaSenior/JavaSeniorPic/image-20210628004418884.png)
...
![image-20210628004518626](https://github.com/HymesZhao/StudyNotes/blob/master/JavaSenior/JavaSeniorPic/image-20210628004518626.png)
...
### 13.3.2、FileInputStream/FileOutputStream的使用
...
![image-20210628005300447](https://github.com/HymesZhao/StudyNotes/blob/master/JavaSenior/JavaSeniorPic/image-20210628005300447.png)

### 13.4.3、典型代码

#### 13.4.3.1、使用BufferedInputStream和BufferedOutputStream
...
#### 13.4.3.2、使用BufferedReader和BufferedWriter
...
![image-20210628005846348](https://github.com/HymesZhao/StudyNotes/blob/master/JavaSenior/JavaSeniorPic/image-20210628005846348.png)
...
- 如何实例化
  ...
  ![image-20210628011435895](https://github.com/HymesZhao/StudyNotes/blob/master/JavaSenior/JavaSeniorPic/image-20210628011435895.png)

- 常用方法

![image-20210628011450049](https://github.com/HymesZhao/StudyNotes/blob/master/JavaSenior/JavaSeniorPic/image-20210628011450049.png)
...
- 常用方法
  ...
  ![image-20210628011644326](https://github.com/HymesZhao/StudyNotes/blob/master/JavaSenior/JavaSeniorPic/image-20210628011644326.png)

![image-20210628011656662](https://github.com/HymesZhao/StudyNotes/blob/master/JavaSenior/JavaSeniorPic/image-20210628011656662.png)
...
![image-20210628012214373](https://github.com/HymesZhao/StudyNotes/blob/master/JavaSenior/JavaSeniorPic/image-20210628012214373.png)

#### 14.1.4.2、TCP和UDP的区别

![image-20210628012248206](https://github.com/HymesZhao/StudyNotes/blob/master/JavaSenior/JavaSeniorPic/image-20210628012248206.png)

#### 14.1.4.3、TCP三次握手和四次挥手

![image-20210628012312832](https://github.com/HymesZhao/StudyNotes/blob/master/JavaSenior/JavaSeniorPic/image-20210628012312832.png)

![image-20210628012323365](https://github.com/HymesZhao/StudyNotes/blob/master/JavaSenior/JavaSeniorPic/image-20210628012323365.png)
...
![image-20210628013104501](https://github.com/HymesZhao/StudyNotes/blob/master/JavaSenior/JavaSeniorPic/image-20210628013104501.png)

### 14.4.5、可以读取、下载对应的url资源
...
![image-20210628230759836](https://github.com/HymesZhao/StudyNotes/blob/master/JavaSenior/JavaSeniorPic/image-20210628230759836.png)
...
### 15.2.4、Class实例可以是哪些结构的说明

![image-20210628231155652](https://github.com/HymesZhao/StudyNotes/blob/master/JavaSenior/JavaSeniorPic/image-20210628231155652.png)

## 15.3、了解ClassLoader

### 15.3.1、类的加载过程

![image-20210628231356979](https://github.com/HymesZhao/StudyNotes/blob/master/JavaSenior/JavaSeniorPic/image-20210628231356979.png)

### 15.3.2、类的加载器的作用

![image-20210628231420029](https://github.com/HymesZhao/StudyNotes/blob/master/JavaSenior/JavaSeniorPic/image-20210628231420029.png)

### 15.3.3、类的加载器的分类

![image-20210628231444488](https://github.com/HymesZhao/StudyNotes/blob/master/JavaSenior/JavaSeniorPic/image-20210628231444488.png)

### 15.3.4、Java类编译、运行的执行的流程

![image-20210628231520556](https://github.com/HymesZhao/StudyNotes/blob/master/JavaSenior/JavaSeniorPic/image-20210628231520556.png)
...
![image-20210628235740522](https://github.com/HymesZhao/StudyNotes/blob/master/JavaSenior/JavaSeniorPic/image-20210628235740522.png)

## 16.2、Lambda表达式

### 16.2.1、Lambda表达式使用前后的对比
...
![image-20210628235958951](https://github.com/HymesZhao/StudyNotes/blob/master/JavaSenior/JavaSeniorPic/image-20210628235958951.png)
...
![image-20210629000314970](https://github.com/HymesZhao/StudyNotes/blob/master/JavaSenior/JavaSeniorPic/image-20210629000314970.png)
...
![image-20210629002122451](https://github.com/HymesZhao/StudyNotes/blob/master/JavaSenior/JavaSeniorPic/image-20210629002122451.png)

### 16.6.7、步骤三：终止操作

![image-20210629002249293](https://github.com/HymesZhao/StudyNotes/blob/master/JavaSenior/JavaSeniorPic/image-20210629002249293.png)

![image-20210629002227469](https://github.com/HymesZhao/StudyNotes/blob/master/JavaSenior/JavaSeniorPic/image-20210629002227469.png)

Collector需要使用Collectors提供实例。

![image-20210629002331956](https://github.com/HymesZhao/StudyNotes/blob/master/JavaSenior/JavaSeniorPic/image-20210629002331956.png)
